    ...
    <div className="tf__privacy-policy">
      <div className="tf__privacy-policy-content">
        ...
        <Typography variant="body-text" color="inverted">
          Tempus Protocol (the “Protocol”) is a decentralized finance application deployed on the relevant blockchain
          (which includes any blockchain that Tempus contracts are deployed on, including but not limited to Ethereum
          and Fantom) that allows suppliers and borrowers of certain cryptoassets to earn yields using smart contracts.
          The Protocol is made up of free, public, open-source or source-available software. Your use of the Protocol
          involves various risks, including, but not limited to, losses while cryptoassets are supplied to the Protocol,
          losses due to the fluctuation of prices of tokens in a pool, and losses due to price slippage and cost. Before
          using the Protocol, you should review the relevant documentation from our GitHub to ensure you understand how
          the Protocol works. Additionally, just as you can access email protocols such as SMTP through multiple email
          ...
          run by smart contracts deployed on the relevant blockchain. Upgrades and modifications to the Protocol are
