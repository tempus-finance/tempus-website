    ...
    <div className="tf__get-involved__cards-grid">
      <div className="tf__get-involved__card tf__get-involved__first-card">
        <GetInvolvedCard
          ...
          description="Tempus Protocol is governed by a decentralized community of TEMPUS token holders and their delegates who propose and vote on upgrades to the protocol."
        />
      </div>
