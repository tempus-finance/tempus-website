  ...
  <div className="tf__tokenomicsSection">
    <div className="tf__tokenomicsSection-content">
      ...
      <Typography variant="token-section-text">
        TEMP is the Tempus ERC-20 native token. It serves three roles: governance, staking to receive a share in network
        fees, and paying protocol fees. 1 billion TEMP tokens were minted at genesis and will become available over the
