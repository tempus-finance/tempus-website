...
function CylinderBig(props, ref){
  ...
  useEffect(function onMount() {
    ...
    small.shadow = elm.getElementById("Small_shadow"),
    small.strings = {
      mask: "",
      path: ""
    },
    ...
    big.shadow = elm.getElementById("Big_shadow"),
    big.strings = {
      mask: "",
      path: ""
    },
  ...
  const createTimeline = () =>{
    ...
    const smallX = bigX - 60
    const smallY = -smallX * 0.5
    const smallFinalY = (heightBig + smallShiftFromSvg + smallY * 1.1)

    const smallShadowX = smallX * 0.49
    const smallShadowY = smallY * 0.49
    ...
    tl.current
      ...
      .to(small.shadow, {duration: 1.6, x: `+=${smallShadowX}`, y: `+=${smallShadowY}`, ease: 'Power1.easeInOut'}, 'scale:end')
      .to([big.all, big.shadow], {duration: 1.6, x: `-=${bigX}`, y: bigY, ease: 'Power1.easeInOut'}, 'scale:end')
    ...
    >
      ...
      <g
        ...
        <path
          ...
          fillRule="nonzero"/>
        <path
          d="M130.162 534.67c-10.266 0-20.51 2.24-28.32 6.717-15.57 8.953-15.57 23.607 0 32.566 7.76 4.476 18.054 6.717 28.32 6.717 10.266 0 20.51-2.24 28.32-6.717 15.576-8.953 15.576-23.607 0-32.566-7.789-4.476-18.054-6.717-28.32-6.717z"
          id="Small_shadow"
          fill="#000000"
          fillRule="nonzero"/>
        <g id="Big_all">
          ...
          <g id="Small_all">
            <g
              ...
              <path
                ...
                d="M-9.74-235.11h33.52V59.72H-9.74z"/>
              <path
                id="Rectangle"
                fill="#000000"
                fillRule="nonzero"
                mask={`url(#${smallMaskName})`}
                d="M-21.84-235.11h33.52V59.72h-33.52z"/>
            </g>
            <path
